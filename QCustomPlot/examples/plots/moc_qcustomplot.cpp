...
**
** Created: Mon Sep 29 22:53:18 2014
...
static const uint qt_meta_data_QCPAxis[] = {
 ...
 // enum data: key, value
    1051, uint(QCPAxis::atLeft),
    1058, uint(QCPAxis::atRight),
    1066, uint(QCPAxis::atTop),
    1072, uint(QCPAxis::atBottom),
    1051, uint(QCPAxis::atLeft),
    1058, uint(QCPAxis::atRight),
    1066, uint(QCPAxis::atTop),
    1072, uint(QCPAxis::atBottom),
    1081, uint(QCPAxis::ltNumber),
    1090, uint(QCPAxis::ltDateTime),
    1101, uint(QCPAxis::stLinear),
    1110, uint(QCPAxis::stLogarithmic),
    1124, uint(QCPAxis::spNone),
    1131, uint(QCPAxis::spAxis),
    1138, uint(QCPAxis::spTickLabels),
    1151, uint(QCPAxis::spAxisLabel),
    1124, uint(QCPAxis::spNone),
    1131, uint(QCPAxis::spAxis),
    1138, uint(QCPAxis::spTickLabels),
    1151, uint(QCPAxis::spAxisLabel),
...
static const char qt_meta_stringdata_QCPAxis[] = {
    ...
    "rangeChanged(QCPRange)\0parts\0"
...
void QCPAxis::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->selectionChanged((*reinterpret_cast< const QCPAxis::SelectableParts(*)>(_a[1]))); break;
        case 3: _t->setRange((*reinterpret_cast< const QCPRange(*)>(_a[1]))); break;
        case 4: _t->setSelectableParts((*reinterpret_cast< const QCPAxis::SelectableParts(*)>(_a[1]))); break;
        case 5: _t->setSelectedParts((*reinterpret_cast< const QCPAxis::SelectableParts(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
static const uint qt_meta_data_QCustomPlot[] = {
 ...
 // properties: name, type, flags
     ...
     983,  968, 0x00095009,
     994,  905, 0x01095103,
    1023, 1019, 0x02095103,
    1042,  905, 0x01095103,
    1084, 1063, 0x0009510b,

 // enums: name, flags, count, data
    1104, 0x0,    2,  155,

 // enum data: key, value
    1120, uint(QCustomPlot::limBelow),
    1129, uint(QCustomPlot::limAbove),
...
static const char qt_meta_stringdata_QCustomPlot[] = {
    ...
    "afterReplot()\0onlyVisible\0rescaleAxes(bool)\0"
    "rescaleAxes()\0deselectAll()\0replot()\0"
